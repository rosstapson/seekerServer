...
var htmlHeader = "<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"utf-8\"><meta name=\"" +
    ...
    "=\"https://seekerdnasecure.co.za:3002/favicon.ico\"><title>Seeker DNA Asset Register</title>" +
    "</head>";
    ...
    var user = User
        ...
        .then(function(user) {
            ...
            res.status(200).send(htmlHeader + htmlBodyTagAndLogo +
                ...
                'fully reset. Please login at <a href="https://seekerdnasecure.co.za">SeekerDnaSecure</a>.</div> ' +
                '</body></html>');
        })
        .catch(function(err) {
            res.status(404).send("user not found");
    ...
    var user = User
        ...
        .then(function(user) {
            ...
            res.status(200).send(htmlHeader + htmlBodyTagAndLogo +
                ...
                ' has been verified. Please login at <a href="https://seekerdnasecure.co.za">SeekerDnaSecure</a>.</div> ' +
                '</body></html>');
        })
        .catch(function(err) {
            res.status(404).send("user not found");
