...
var htmlHeader = "<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"utf-8\"><meta name=\"" +
    ...
    "=\"http://localhost:3001/favicon.ico\"><title>Seeker DNA Asset Register</title>" +
...
var htmlBodyTagAndLogo = '<body><div style=" margin: auto;"><img src="http://localhost:3001/logo.png" style="height: 200px; display: block; margin: auto;" alt="logo"/></div>';
var htmlBodyTagWithOnload = '<body onload="loadInputs()"><div style=" margin: auto;"><img src="http://localhost:3001/logo.png" style="height: 200px; display: block; margin: auto;" alt="logo"/></div>';
...
var loadInputs = '<script >function loadInputs() { ' +
    ' document.getElementById("myForm").action = "http://localhost:3001/api/resetuserpassword/';
var endLoadInputs = '";  ' +
    ' }</script>';
